...
@dataclass
class LatentRNNConfig:
    """Latent RNN configuration with model and training settings."""
...
def build_config(dataset_config: DatasetConfig, ae_config: AEConfig, **overrides) -> LatentRNNConfig:
    """Build latent RNN config for a dataset."""
    return LatentRNNConfig(dataset_config=dataset_config, ae_config=ae_config, **overrides)
