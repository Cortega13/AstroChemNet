"""Latent RNN benchmark entrypoint."""
...
def benchmark(dataset_config):
    """Benchmark latent RNN model for a dataset."""
    ...
    latent_rnn = load_latent_rnn(LatentRNN, dataset_config, model_config, inference=True)
    ...
    with torch.no_grad():
        predicted_latents = latent_rnn(physical_parameters, features)
