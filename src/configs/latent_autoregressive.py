...
@dataclass
class ARConfig:
    """LatentAR model configuration with hyperparameters and paths.
    ...
    def __post_init__(self) -> None:
        ...
        self.pretrained_model_path = os.path.join(
            self.dataset_config.weights_dir, "latent_autoregressive.pth"
        )
        self.save_model_path = os.path.join(self.dataset_config.weights_dir, "latent_autoregressive.pth")
